...
namespace common::errormsg::cor {
    ...
    ON_INIT{
        ...
        ADD(0x8004dead, "E_SYM_DESTROYED", nil, "corsym.h");
        ADD(0x80070002, "COR_E_FILENOTFOUND", nil, "corerror.h");
        ...
        ADD(0x80131013, "COR_E_TYPEUNLOADED", nil, "corerror.h");
        ...
        ADD(0x80131018, "COR_E_ASSEMBLYEXPECTED", nil, "corerror.h");
        ...
        ADD(0x80131025, "HOST_E_NOT_OWNER", nil, "corerror.h");
        ...
        ADD(0x80131450, "ISS_E_ISOSTORE", nil, "corerror.h");
        ADD(0x80131450, "ISS_E_ISOSTORE_START", nil, "corerror.h");
        ADD(0x80131460, "ISS_E_OPEN_STORE_FILE", nil, "corerror.h");
        ADD(0x80131461, "ISS_E_OPEN_FILE_MAPPING", nil, "corerror.h");
        ADD(0x80131462, "ISS_E_MAP_VIEW_OF_FILE", nil, "corerror.h");
        ADD(0x80131463, "ISS_E_GET_FILE_SIZE", nil, "corerror.h");
        ADD(0x80131464, "ISS_E_CREATE_MUTEX", nil, "corerror.h");
        ADD(0x80131465, "ISS_E_LOCK_FAILED", nil, "corerror.h");
        ADD(0x80131466, "ISS_E_FILE_WRITE", nil, "corerror.h");
        ADD(0x80131467, "ISS_E_SET_FILE_POINTER", nil, "corerror.h");
        ADD(0x80131468, "ISS_E_CREATE_DIR", nil, "corerror.h");
        ADD(0x80131469, "ISS_E_STORE_NOT_OPEN", nil, "corerror.h");
        ADD(0x80131480, "ISS_E_CORRUPTED_STORE_FILE", nil, "corerror.h");
        ADD(0x80131481, "ISS_E_STORE_VERSION", nil, "corerror.h");
        ADD(0x80131482, "ISS_E_FILE_NOT_MAPPED", nil, "corerror.h");
        ADD(0x80131483, "ISS_E_BLOCK_SIZE_TOO_SMALL", nil, "corerror.h");
        ADD(0x80131484, "ISS_E_ALLOC_TOO_LARGE", nil, "corerror.h");
        ADD(0x80131485, "ISS_E_USAGE_WILL_EXCEED_QUOTA", nil, "corerror.h");
        ADD(0x80131486, "ISS_E_TABLE_ROW_NOT_FOUND", nil, "corerror.h");
        ADD(0x801314a0, "ISS_E_DEPRECATE", nil, "corerror.h");
        ADD(0x801314a1, "ISS_E_CALLER", nil, "corerror.h");
        ADD(0x801314a2, "ISS_E_PATH_LENGTH", nil, "corerror.h");
        ADD(0x801314a3, "ISS_E_MACHINE", nil, "corerror.h");
        ADD(0x801314a4, "ISS_E_MACHINE_DACL", nil, "corerror.h");
        ADD(0x801314ff, "ISS_E_ISOSTORE_END", nil, "corerror.h");
        ADD(0x80131500, "COR_E_EXCEPTION", "Base class for all exceptions in the runtime", "corerror.h");
        ADD(0x80131500, "COR_E_EXCEPTION", nil, "corerror.h");
        ADD(0x80131501, "COR_E_SYSTEM", "The base class for the runtime's \"less serious\" exceptions", "corerror.h");
        ADD(0x80131501, "COR_E_SYSTEM", nil, "corerror.h");
        ADD(0x80131502, "COR_E_ARGUMENTOUTOFRANGE", "An argument was out of its legal range.", "corerror.h");
        ADD(0x80131502, "COR_E_ARGUMENTOUTOFRANGE", nil, "corerror.h");
        ADD(0x80131503, "COR_E_ARRAYTYPEMISMATCH", "Attempted to store an object of the wrong type in an array", "corerror.h");
        ADD(0x80131503, "COR_E_ARRAYTYPEMISMATCH", nil, "corerror.h");
        ADD(0x80131504, "COR_E_CONTEXTMARSHAL", nil, "corerror.h");
        ADD(0x80131504, "COR_E_CONTEXTMARSHAL", nil, "corerror.h");
        ADD(0x80131505, "COR_E_TIMEOUT", nil, "corerror.h");
        ADD(0x80131505, "COR_E_TIMEOUT", nil, "corerror.h");
        ...
        ADD(0x80131506, "COR_E_EXECUTIONENGINE", nil, "corerror.h");
        ADD(0x80131507, "COR_E_FIELDACCESS", "Access to this field is denied.", "corerror.h");
        ADD(0x80131507, "COR_E_FIELDACCESS", nil, "corerror.h");
        ...
        ADD(0x80131531, "COR_E_INVALIDOLEVARIANTTYPE", nil, "corerror.h");
        ADD(0x80131532, "COR_E_MISSINGMANIFESTRESOURCE", "An expected resource in the assembly manifest was missing.", "corerror.h");
        ADD(0x80131532, "COR_E_MISSINGMANIFESTRESOURCE", nil, "corerror.h");
        ...
        ADD(0x80131538, "COR_E_SAFEARRAYRANKMISMATCH", nil, "corerror.h");
        ADD(0x80131539, "COR_E_PLATFORMNOTSUPPORTED", "The method is not supported on this platform", "corerror.h");
        ADD(0x80131539, "COR_E_PLATFORMNOTSUPPORTED", nil, "corerror.h");
        ...
        ADD(0x8013153a, "COR_E_INVALIDPROGRAM", nil, "corerror.h");
        ADD(0x8013153b, "COR_E_OPERATIONCANCELED", "The operation was cancelled.", "corerror.h");
        ADD(0x8013153b, "COR_E_OPERATIONCANCELED", nil, "corerror.h");
        ...
        ADD(0x8013153d, "COR_E_INSUFFICIENTMEMORY", nil, "corerror.h");
        ...
        ADD(0x80131641, "COR_E_ILLEGAL_REENTRANCY", nil, "corerror.h");
        ...
        ADD(0x80131801, "VER_E_HRESULT", nil, "corerror.h");
        ADD(0x80131802, "VER_E_OFFSET", nil, "corerror.h");
        ADD(0x80131803, "VER_E_OPCODE", nil, "corerror.h");
        ADD(0x80131804, "VER_E_OPERAND", nil, "corerror.h");
        ADD(0x80131805, "VER_E_TOKEN", nil, "corerror.h");
        ADD(0x80131806, "VER_E_EXCEPT", nil, "corerror.h");
        ADD(0x80131807, "VER_E_STACK_SLOT", nil, "corerror.h");
        ADD(0x80131808, "VER_E_LOC", nil, "corerror.h");
        ADD(0x80131809, "VER_E_ARG", nil, "corerror.h");
        ADD(0x8013180a, "VER_E_FOUND", nil, "corerror.h");
        ADD(0x8013180b, "VER_E_EXPECTED", nil, "corerror.h");
        ADD(0x8013180c, "VER_E_LOC_BYNAME", nil, "corerror.h");
        ADD(0x80131810, "VER_E_UNKNOWN_OPCODE", nil, "corerror.h");
        ADD(0x80131811, "VER_E_SIG_CALLCONV", nil, "corerror.h");
        ADD(0x80131812, "VER_E_SIG_ELEMTYPE", nil, "corerror.h");
        ADD(0x80131814, "VER_E_RET_SIG", nil, "corerror.h");
        ADD(0x80131815, "VER_E_FIELD_SIG", nil, "corerror.h");
        ADD(0x80131818, "VER_E_INTERNAL", nil, "corerror.h");
        ADD(0x80131819, "VER_E_STACK_TOO_LARGE", nil, "corerror.h");
        ADD(0x8013181a, "VER_E_ARRAY_NAME_LONG", nil, "corerror.h");
        ADD(0x80131820, "VER_E_FALLTHRU", nil, "corerror.h");
        ADD(0x80131821, "VER_E_TRY_GTEQ_END", nil, "corerror.h");
        ADD(0x80131822, "VER_E_TRYEND_GT_CS", nil, "corerror.h");
        ADD(0x80131823, "VER_E_HND_GTEQ_END", nil, "corerror.h");
        ADD(0x80131824, "VER_E_HNDEND_GT_CS", nil, "corerror.h");
        ADD(0x80131825, "VER_E_FLT_GTEQ_CS", nil, "corerror.h");
        ADD(0x80131826, "VER_E_TRY_START", nil, "corerror.h");
        ADD(0x80131827, "VER_E_HND_START", nil, "corerror.h");
        ADD(0x80131828, "VER_E_FLT_START", nil, "corerror.h");
        ADD(0x80131829, "VER_E_TRY_OVERLAP", nil, "corerror.h");
        ADD(0x8013182a, "VER_E_TRY_EQ_HND_FIL", nil, "corerror.h");
        ADD(0x8013182b, "VER_E_TRY_SHARE_FIN_FAL", nil, "corerror.h");
        ADD(0x8013182c, "VER_E_HND_OVERLAP", nil, "corerror.h");
        ADD(0x8013182d, "VER_E_HND_EQ", nil, "corerror.h");
        ADD(0x8013182e, "VER_E_FIL_OVERLAP", nil, "corerror.h");
        ADD(0x8013182f, "VER_E_FIL_EQ", nil, "corerror.h");
        ADD(0x80131830, "VER_E_FIL_CONT_TRY", nil, "corerror.h");
        ADD(0x80131831, "VER_E_FIL_CONT_HND", nil, "corerror.h");
        ADD(0x80131832, "VER_E_FIL_CONT_FIL", nil, "corerror.h");
        ADD(0x80131833, "VER_E_FIL_GTEQ_CS", nil, "corerror.h");
        ADD(0x80131834, "VER_E_FIL_START", nil, "corerror.h");
        ADD(0x80131835, "VER_E_FALLTHRU_EXCEP", nil, "corerror.h");
        ADD(0x80131836, "VER_E_FALLTHRU_INTO_HND", nil, "corerror.h");
        ADD(0x80131837, "VER_E_FALLTHRU_INTO_FIL", nil, "corerror.h");
        ADD(0x80131838, "VER_E_LEAVE", nil, "corerror.h");
        ADD(0x80131839, "VER_E_RETHROW", nil, "corerror.h");
        ADD(0x8013183a, "VER_E_ENDFINALLY", nil, "corerror.h");
        ADD(0x8013183b, "VER_E_ENDFILTER", nil, "corerror.h");
        ADD(0x8013183c, "VER_E_ENDFILTER_MISSING", nil, "corerror.h");
        ADD(0x8013183d, "VER_E_BR_INTO_TRY", nil, "corerror.h");
        ADD(0x8013183e, "VER_E_BR_INTO_HND", nil, "corerror.h");
        ADD(0x8013183f, "VER_E_BR_INTO_FIL", nil, "corerror.h");
        ADD(0x80131840, "VER_E_BR_OUTOF_TRY", nil, "corerror.h");
        ADD(0x80131841, "VER_E_BR_OUTOF_HND", nil, "corerror.h");
        ADD(0x80131842, "VER_E_BR_OUTOF_FIL", nil, "corerror.h");
        ADD(0x80131843, "VER_E_BR_OUTOF_FIN", nil, "corerror.h");
        ADD(0x80131844, "VER_E_RET_FROM_TRY", nil, "corerror.h");
        ADD(0x80131845, "VER_E_RET_FROM_HND", nil, "corerror.h");
        ADD(0x80131846, "VER_E_RET_FROM_FIL", nil, "corerror.h");
        ADD(0x80131847, "VER_E_BAD_JMP_TARGET", nil, "corerror.h");
        ADD(0x80131848, "VER_E_PATH_LOC", nil, "corerror.h");
        ADD(0x80131849, "VER_E_PATH_THIS", nil, "corerror.h");
        ADD(0x8013184a, "VER_E_PATH_STACK", nil, "corerror.h");
        ADD(0x8013184b, "VER_E_PATH_STACK_DEPTH", nil, "corerror.h");
        ADD(0x8013184c, "VER_E_THIS", nil, "corerror.h");
        ADD(0x8013184d, "VER_E_THIS_UNINIT_EXCEP", nil, "corerror.h");
        ADD(0x8013184e, "VER_E_THIS_UNINIT_STORE", nil, "corerror.h");
        ADD(0x8013184f, "VER_E_THIS_UNINIT_RET", nil, "corerror.h");
        ADD(0x80131850, "VER_E_THIS_UNINIT_V_RET", nil, "corerror.h");
        ADD(0x80131851, "VER_E_THIS_UNINIT_BR", nil, "corerror.h");
        ADD(0x80131852, "VER_E_LDFTN_CTOR", nil, "corerror.h");
        ADD(0x80131853, "VER_E_STACK_NOT_EQ", nil, "corerror.h");
        ADD(0x80131854, "VER_E_STACK_UNEXPECTED", nil, "corerror.h");
        ADD(0x80131855, "VER_E_STACK_EXCEPTION", nil, "corerror.h");
        ADD(0x80131856, "VER_E_STACK_OVERFLOW", nil, "corerror.h");
        ADD(0x80131857, "VER_E_STACK_UNDERFLOW", nil, "corerror.h");
        ADD(0x80131858, "VER_E_STACK_EMPTY", nil, "corerror.h");
        ADD(0x80131859, "VER_E_STACK_UNINIT", nil, "corerror.h");
        ADD(0x8013185a, "VER_E_STACK_I_I4_I8", nil, "corerror.h");
        ADD(0x8013185b, "VER_E_STACK_R_R4_R8", nil, "corerror.h");
        ADD(0x8013185c, "VER_E_STACK_NO_R_I8", nil, "corerror.h");
        ADD(0x8013185d, "VER_E_STACK_NUMERIC", nil, "corerror.h");
        ADD(0x8013185e, "VER_E_STACK_OBJREF", nil, "corerror.h");
        ADD(0x8013185f, "VER_E_STACK_P_OBJREF", nil, "corerror.h");
        ADD(0x80131860, "VER_E_STACK_BYREF", nil, "corerror.h");
        ADD(0x80131861, "VER_E_STACK_METHOD", nil, "corerror.h");
        ADD(0x80131862, "VER_E_STACK_ARRAY_SD", nil, "corerror.h");
        ADD(0x80131863, "VER_E_STACK_VALCLASS", nil, "corerror.h");
        ADD(0x80131864, "VER_E_STACK_P_VALCLASS", nil, "corerror.h");
        ADD(0x80131865, "VER_E_STACK_NO_VALCLASS", nil, "corerror.h");
        ADD(0x80131866, "VER_E_LOC_DEAD", nil, "corerror.h");
        ADD(0x80131867, "VER_E_LOC_NUM", nil, "corerror.h");
        ADD(0x80131868, "VER_E_ARG_NUM", nil, "corerror.h");
        ADD(0x80131869, "VER_E_TOKEN_RESOLVE", nil, "corerror.h");
        ADD(0x8013186a, "VER_E_TOKEN_TYPE", nil, "corerror.h");
        ADD(0x8013186b, "VER_E_TOKEN_TYPE_MEMBER", nil, "corerror.h");
        ADD(0x8013186c, "VER_E_TOKEN_TYPE_FIELD", nil, "corerror.h");
        ADD(0x8013186d, "VER_E_TOKEN_TYPE_SIG", nil, "corerror.h");
        ADD(0x8013186e, "VER_E_UNVERIFIABLE", nil, "corerror.h");
        ADD(0x8013186f, "VER_E_LDSTR_OPERAND", nil, "corerror.h");
        ADD(0x80131870, "VER_E_RET_PTR_TO_STACK", nil, "corerror.h");
        ADD(0x80131871, "VER_E_RET_VOID", nil, "corerror.h");
        ADD(0x80131872, "VER_E_RET_MISSING", nil, "corerror.h");
        ADD(0x80131873, "VER_E_RET_EMPTY", nil, "corerror.h");
        ADD(0x80131874, "VER_E_RET_UNINIT", nil, "corerror.h");
        ADD(0x80131875, "VER_E_ARRAY_ACCESS", nil, "corerror.h");
        ADD(0x80131876, "VER_E_ARRAY_V_STORE", nil, "corerror.h");
        ADD(0x80131877, "VER_E_ARRAY_SD", nil, "corerror.h");
        ADD(0x80131878, "VER_E_ARRAY_SD_PTR", nil, "corerror.h");
        ADD(0x80131879, "VER_E_ARRAY_FIELD", nil, "corerror.h");
        ADD(0x8013187a, "VER_E_ARGLIST", nil, "corerror.h");
        ADD(0x8013187b, "VER_E_VALCLASS", nil, "corerror.h");
        ADD(0x8013187c, "VER_E_METHOD_ACCESS", nil, "corerror.h");
        ADD(0x8013187d, "VER_E_FIELD_ACCESS", nil, "corerror.h");
        ADD(0x8013187e, "VER_E_DEAD", nil, "corerror.h");
        ADD(0x8013187f, "VER_E_FIELD_STATIC", nil, "corerror.h");
        ADD(0x80131880, "VER_E_FIELD_NO_STATIC", nil, "corerror.h");
        ADD(0x80131881, "VER_E_ADDR", nil, "corerror.h");
        ADD(0x80131882, "VER_E_ADDR_BYREF", nil, "corerror.h");
        ADD(0x80131883, "VER_E_ADDR_LITERAL", nil, "corerror.h");
        ADD(0x80131884, "VER_E_INITONLY", nil, "corerror.h");
        ADD(0x80131885, "VER_E_THROW", nil, "corerror.h");
        ADD(0x80131886, "VER_E_CALLVIRT_VALCLASS", nil, "corerror.h");
        ADD(0x80131887, "VER_E_CALL_SIG", nil, "corerror.h");
        ADD(0x80131888, "VER_E_CALL_STATIC", nil, "corerror.h");
        ADD(0x80131889, "VER_E_CTOR", nil, "corerror.h");
        ADD(0x8013188a, "VER_E_CTOR_VIRT", nil, "corerror.h");
        ADD(0x8013188b, "VER_E_CTOR_OR_SUPER", nil, "corerror.h");
        ADD(0x8013188c, "VER_E_CTOR_MUL_INIT", nil, "corerror.h");
        ADD(0x8013188d, "VER_E_SIG", nil, "corerror.h");
        ADD(0x8013188e, "VER_E_SIG_ARRAY", nil, "corerror.h");
        ADD(0x8013188f, "VER_E_SIG_ARRAY_PTR", nil, "corerror.h");
        ADD(0x80131890, "VER_E_SIG_ARRAY_BYREF", nil, "corerror.h");
        ADD(0x80131891, "VER_E_SIG_ELEM_PTR", nil, "corerror.h");
        ADD(0x80131892, "VER_E_SIG_VARARG", nil, "corerror.h");
        ADD(0x80131893, "VER_E_SIG_VOID", nil, "corerror.h");
        ADD(0x80131894, "VER_E_SIG_BYREF_BYREF", nil, "corerror.h");
        ADD(0x80131896, "VER_E_CODE_SIZE_ZERO", nil, "corerror.h");
        ADD(0x80131897, "VER_E_BAD_VARARG", nil, "corerror.h");
        ADD(0x80131898, "VER_E_TAIL_CALL", nil, "corerror.h");
        ADD(0x80131899, "VER_E_TAIL_BYREF", nil, "corerror.h");
        ADD(0x8013189a, "VER_E_TAIL_RET", nil, "corerror.h");
        ADD(0x8013189b, "VER_E_TAIL_RET_VOID", nil, "corerror.h");
        ADD(0x8013189c, "VER_E_TAIL_RET_TYPE", nil, "corerror.h");
        ADD(0x8013189d, "VER_E_TAIL_STACK_EMPTY", nil, "corerror.h");
        ADD(0x8013189e, "VER_E_METHOD_END", nil, "corerror.h");
        ADD(0x8013189f, "VER_E_BAD_BRANCH", nil, "corerror.h");
        ADD(0x801318a0, "VER_E_FIN_OVERLAP", nil, "corerror.h");
        ADD(0x801318a1, "VER_E_LEXICAL_NESTING", nil, "corerror.h");
        ADD(0x801318a2, "VER_E_VOLATILE", nil, "corerror.h");
        ADD(0x801318a3, "VER_E_UNALIGNED", nil, "corerror.h");
        ADD(0x801318a4, "VER_E_INNERMOST_FIRST", nil, "corerror.h");
        ADD(0x801318a5, "VER_E_CALLI_VIRTUAL", nil, "corerror.h");
        ADD(0x801318a6, "VER_E_CALL_ABSTRACT", nil, "corerror.h");
        ADD(0x801318a7, "VER_E_STACK_UNEXP_ARRAY", nil, "corerror.h");
        ADD(0x801318a8, "VER_E_NOT_IN_GC_HEAP", nil, "corerror.h");
        ADD(0x801318a9, "VER_E_TRY_N_EMPTY_STACK", nil, "corerror.h");
        ADD(0x801318aa, "VER_E_DLGT_CTOR", nil, "corerror.h");
        ADD(0x801318ab, "VER_E_DLGT_BB", nil, "corerror.h");
        ADD(0x801318ac, "VER_E_DLGT_PATTERN", nil, "corerror.h");
        ADD(0x801318ad, "VER_E_DLGT_LDFTN", nil, "corerror.h");
        ADD(0x801318ae, "VER_E_FTN_ABSTRACT", nil, "corerror.h");
        ADD(0x801318af, "VER_E_SIG_C_VC", nil, "corerror.h");
        ADD(0x801318b0, "VER_E_SIG_VC_C", nil, "corerror.h");
        ADD(0x801318b1, "VER_E_BOX_PTR_TO_STACK", nil, "corerror.h");
        ADD(0x801318b2, "VER_E_SIG_BYREF_TB_AH", nil, "corerror.h");
        ADD(0x801318b3, "VER_E_SIG_ARRAY_TB_AH", nil, "corerror.h");
        ADD(0x801318b4, "VER_E_ENDFILTER_STACK", nil, "corerror.h");
        ADD(0x801318b5, "VER_E_DLGT_SIG_I", nil, "corerror.h");
        ADD(0x801318b6, "VER_E_DLGT_SIG_O", nil, "corerror.h");
        ADD(0x801318b7, "VER_E_RA_PTR_TO_STACK", nil, "corerror.h");
        ADD(0x801318b8, "VER_E_CATCH_VALUE_TYPE", nil, "corerror.h");
        ADD(0x801318b9, "VER_E_CATCH_BYREF", nil, "corerror.h");
        ADD(0x801318ba, "VER_E_FIL_PRECEED_HND", nil, "corerror.h");
        ADD(0x801318bb, "VER_E_LDVIRTFTN_STATIC", nil, "corerror.h");
        ADD(0x801318bc, "VER_E_CALLVIRT_STATIC", nil, "corerror.h");
        ADD(0x801318bd, "VER_E_INITLOCALS", nil, "corerror.h");
        ADD(0x801318be, "VER_E_BR_TO_EXCEPTION", nil, "corerror.h");
        ADD(0x801318bf, "VER_E_CALL_CTOR", nil, "corerror.h");
        ADD(0x801318c0, "VER_E_VALCLASS_OBJREF_VAR", nil, "corerror.h");
        ADD(0x801318c1, "VER_E_STACK_P_VALCLASS_OBJREF_VAR", nil, "corerror.h");
        ADD(0x801318c2, "VER_E_SIG_VAR_PARAM", nil, "corerror.h");
        ADD(0x801318c3, "VER_E_SIG_MVAR_PARAM", nil, "corerror.h");
        ADD(0x801318c4, "VER_E_SIG_VAR_ARG", nil, "corerror.h");
        ADD(0x801318c5, "VER_E_SIG_MVAR_ARG", nil, "corerror.h");
        ADD(0x801318c6, "VER_E_SIG_GENERICINST", nil, "corerror.h");
        ADD(0x801318c7, "VER_E_SIG_METHOD_INST", nil, "corerror.h");
        ADD(0x801318c8, "VER_E_SIG_METHOD_PARENT_INST", nil, "corerror.h");
        ADD(0x801318c9, "VER_E_SIG_FIELD_PARENT_INST", nil, "corerror.h");
        ADD(0x801318ca, "VER_E_CALLCONV_NOT_GENERICINST", nil, "corerror.h");
        ADD(0x801318cb, "VER_E_TOKEN_BAD_METHOD_SPEC", nil, "corerror.h");
        ADD(0x801318cc, "VER_E_BAD_READONLY_PREFIX", nil, "corerror.h");
        ADD(0x801318cd, "VER_E_BAD_CONSTRAINED_PREFIX", nil, "corerror.h");
        ADD(0x801318ce, "VER_E_CIRCULAR_VAR_CONSTRAINTS", nil, "corerror.h");
        ADD(0x801318cf, "VER_E_CIRCULAR_MVAR_CONSTRAINTS", nil, "corerror.h");
        ADD(0x801318d0, "VER_E_UNSATISFIED_METHOD_INST", nil, "corerror.h");
        ADD(0x801318d1, "VER_E_UNSATISFIED_METHOD_PARENT_INST", nil, "corerror.h");
        ADD(0x801318d2, "VER_E_UNSATISFIED_FIELD_PARENT_INST", nil, "corerror.h");
        ADD(0x801318d3, "VER_E_UNSATISFIED_BOX_OPERAND", nil, "corerror.h");
        ADD(0x801318d4, "VER_E_CONSTRAINED_CALL_WITH_NON_BYREF_THIS", nil, "corerror.h");
        ADD(0x801318d5, "VER_E_CONSTRAINED_OF_NON_VARIABLE_TYPE", nil, "corerror.h");
        ADD(0x801318d6, "VER_E_READONLY_UNEXPECTED_CALLEE", nil, "corerror.h");
        ADD(0x801318d7, "VER_E_READONLY_ILLEGAL_WRITE", nil, "corerror.h");
        ADD(0x801318d8, "VER_E_READONLY_IN_MKREFANY", nil, "corerror.h");
        ADD(0x801318d9, "VER_E_UNALIGNED_ALIGNMENT", nil, "corerror.h");
        ADD(0x801318da, "VER_E_TAILCALL_INSIDE_EH", nil, "corerror.h");
        ADD(0x801318db, "VER_E_BACKWARD_BRANCH", nil, "corerror.h");
        ADD(0x801318dc, "VER_E_CALL_TO_VTYPE_BASE", nil, "corerror.h");
        ADD(0x801318dd, "VER_E_NEWOBJ_OF_ABSTRACT_CLASS", nil, "corerror.h");
        ADD(0x801318de, "VER_E_UNMANAGED_POINTER", nil, "corerror.h");
        ADD(0x801318df, "VER_E_LDFTN_NON_FINAL_VIRTUAL", nil, "corerror.h");
        ADD(0x801318e0, "VER_E_FIELD_OVERLAP", nil, "corerror.h");
        ADD(0x801318e1, "VER_E_THIS_MISMATCH", nil, "corerror.h");
        ADD(0x801318e2, "VER_E_STACK_I_I4", nil, "corerror.h");
        ADD(0x801318f0, "VER_E_BAD_PE", nil, "corerror.h");
        ADD(0x801318f1, "VER_E_BAD_MD", nil, "corerror.h");
        ADD(0x801318f2, "VER_E_BAD_APPDOMAIN", nil, "corerror.h");
        ADD(0x801318f3, "VER_E_TYPELOAD", nil, "corerror.h");
        ADD(0x801318f4, "VER_E_PE_LOAD", nil, "corerror.h");
        ADD(0x801318f5, "VER_E_WRITE_RVA_STATIC", nil, "corerror.h");
        ADD(0x80131904, "COR_E_SqlException", "System.Data.SqlClient.SqlClientException", "corerror.h");
        ADD(0x80131920, "COR_E_Data", nil, "corerror.h");
        ADD(0x80131921, "COR_E_DataDeletedRowInaccessible", nil, "corerror.h");
        ADD(0x80131922, "COR_E_DataDuplicateName", nil, "corerror.h");
        ADD(0x80131923, "COR_E_DataInRowChangingEvent", nil, "corerror.h");
        ADD(0x80131924, "COR_E_DataInvalidConstraint", nil, "corerror.h");
        ADD(0x80131925, "COR_E_DataMissingPrimaryKey", nil, "corerror.h");
        ADD(0x80131926, "COR_E_DataNoNullAllowed", nil, "corerror.h");
        ADD(0x80131927, "COR_E_DataReadOnly", nil, "corerror.h");
        ADD(0x80131928, "COR_E_DataRowNotInTable", nil, "corerror.h");
        ADD(0x80131929, "COR_E_DataVersionNotFound", nil, "corerror.h");
        ADD(0x8013192a, "COR_E_DataConstraint", nil, "corerror.h");
        ADD(0x8013192b, "COR_E_StrongTyping", nil, "corerror.h");
        ADD(0x80131930, "COR_E_SqlType", nil, "corerror.h");
        ADD(0x80131931, "COR_E_SqlNullValue", nil, "corerror.h");
        ADD(0x80131932, "COR_E_SqlTruncate", nil, "corerror.h");
        ADD(0x80131933, "COR_E_AdapterMapping", nil, "corerror.h");
        ADD(0x80131934, "COR_E_DataAdapter", nil, "corerror.h");
        ADD(0x80131935, "COR_E_DBConcurrency", nil, "corerror.h");
        ADD(0x80131936, "COR_E_OperationAborted", nil, "corerror.h");
        ADD(0x80131937, "COR_E_InvalidUdt", nil, "corerror.h");
        ...
        ADD(0x80131940, "COR_E_Xml", nil, "corerror.h");
        ADD(0x80131941, "COR_E_XmlSchema", nil, "corerror.h");
        ADD(0x80131942, "COR_E_XmlXslt", nil, "corerror.h");
        ADD(0x80131943, "COR_E_XmlXPath", nil, "corerror.h");
        ADD(0x80131944, "COR_E_XmlQuery", nil, "corerror.h");
        ...
        ADD(0x80131c27, "CORDBG_E_MINIDUMP_UNSUPPORTED", nil, "corerror.h");
        ...
        ADD(0x80131fff, "CLDB_E_INTERNALERROR", nil, "corerror.h");
    };
    ON_INIT{
