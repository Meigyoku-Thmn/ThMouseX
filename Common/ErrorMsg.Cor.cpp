...
namespace common::errormsg::cor {
    ...
    ON_INIT{
        ...
        ADD(0x8004dead, "E_SYM_DESTROYED", null, "corsym.h");
        ADD(0x80070002, "COR_E_FILENOTFOUND", null, "corerror.h");
        ...
        ADD(0x80131013, "COR_E_TYPEUNLOADED", null, "corerror.h");
        ...
        ADD(0x80131018, "COR_E_ASSEMBLYEXPECTED", null, "corerror.h");
        ...
        ADD(0x80131025, "HOST_E_NOT_OWNER", null, "corerror.h");
        ...
        ADD(0x80131164, "TLBX_E_CANT_SAVE", "Typelib export: cant \"SaveAllChanges()\"", "corerror.h");
        ...
        ADD(0x80131175, "TLBX_E_ASANY", "Typelib export: Encounterd \"AsAny\" -- ignored.", "corerror.h");
        ...
        ADD(0x80131261, "VLDTR_E_TD_ENUMNOVALUE", "Enum has no \"value__\" field.", "corerror.h");
        ADD(0x80131262, "VLDTR_E_TD_ENUMVALSTATIC", "Enum's \"value__\" field is static.", "corerror.h");
        ADD(0x80131263, "VLDTR_E_TD_ENUMVALNOTSN", "Enum's \"value__\" field is not SpecialName.", "corerror.h");
        ...
        ADD(0x80131268, "VLDTR_E_TD_ENUMVALNOT1ST", "Enum's \"value__\" field is not first.", "corerror.h");
        ADD(0x80131269, "VLDTR_E_FD_NOTVALUERTSN", "Field is RTSpecialName but name is not \"value__\".", "corerror.h");
        ADD(0x8013126a, "VLDTR_E_FD_VALUEPARNOTENUM", "Field \"value__\" in not Enum class.", "corerror.h");
        ...
        ADD(0x80131341, "CORDBG_E_ENC_INTERNAL_ERROR", "Generic message for \"Something user doesn't control went wrong\" message.", "corerror.h");
        ...
        ADD(0x80131450, "ISS_E_ISOSTORE", null, "corerror.h");
        ADD(0x80131450, "ISS_E_ISOSTORE_START", null, "corerror.h");
        ADD(0x80131460, "ISS_E_OPEN_STORE_FILE", null, "corerror.h");
        ADD(0x80131461, "ISS_E_OPEN_FILE_MAPPING", null, "corerror.h");
        ADD(0x80131462, "ISS_E_MAP_VIEW_OF_FILE", null, "corerror.h");
        ADD(0x80131463, "ISS_E_GET_FILE_SIZE", null, "corerror.h");
        ADD(0x80131464, "ISS_E_CREATE_MUTEX", null, "corerror.h");
        ADD(0x80131465, "ISS_E_LOCK_FAILED", null, "corerror.h");
        ADD(0x80131466, "ISS_E_FILE_WRITE", null, "corerror.h");
        ADD(0x80131467, "ISS_E_SET_FILE_POINTER", null, "corerror.h");
        ADD(0x80131468, "ISS_E_CREATE_DIR", null, "corerror.h");
        ADD(0x80131469, "ISS_E_STORE_NOT_OPEN", null, "corerror.h");
        ADD(0x80131480, "ISS_E_CORRUPTED_STORE_FILE", null, "corerror.h");
        ADD(0x80131481, "ISS_E_STORE_VERSION", null, "corerror.h");
        ADD(0x80131482, "ISS_E_FILE_NOT_MAPPED", null, "corerror.h");
        ADD(0x80131483, "ISS_E_BLOCK_SIZE_TOO_SMALL", null, "corerror.h");
        ADD(0x80131484, "ISS_E_ALLOC_TOO_LARGE", null, "corerror.h");
        ADD(0x80131485, "ISS_E_USAGE_WILL_EXCEED_QUOTA", null, "corerror.h");
        ADD(0x80131486, "ISS_E_TABLE_ROW_NOT_FOUND", null, "corerror.h");
        ADD(0x801314a0, "ISS_E_DEPRECATE", null, "corerror.h");
        ADD(0x801314a1, "ISS_E_CALLER", null, "corerror.h");
        ADD(0x801314a2, "ISS_E_PATH_LENGTH", null, "corerror.h");
        ADD(0x801314a3, "ISS_E_MACHINE", null, "corerror.h");
        ADD(0x801314a4, "ISS_E_MACHINE_DACL", null, "corerror.h");
        ADD(0x801314ff, "ISS_E_ISOSTORE_END", null, "corerror.h");
        ADD(0x80131500, "COR_E_EXCEPTION", "Base class for all exceptions in the runtime", "corerror.h");
        ADD(0x80131500, "COR_E_EXCEPTION", null, "corerror.h");
        ADD(0x80131501, "COR_E_SYSTEM", "The base class for the runtime's \"less serious\" exceptions", "corerror.h");
        ADD(0x80131501, "COR_E_SYSTEM", null, "corerror.h");
        ADD(0x80131502, "COR_E_ARGUMENTOUTOFRANGE", "An argument was out of its legal range.", "corerror.h");
        ADD(0x80131502, "COR_E_ARGUMENTOUTOFRANGE", null, "corerror.h");
        ADD(0x80131503, "COR_E_ARRAYTYPEMISMATCH", "Attempted to store an object of the wrong type in an array", "corerror.h");
        ADD(0x80131503, "COR_E_ARRAYTYPEMISMATCH", null, "corerror.h");
        ADD(0x80131504, "COR_E_CONTEXTMARSHAL", null, "corerror.h");
        ADD(0x80131504, "COR_E_CONTEXTMARSHAL", null, "corerror.h");
        ADD(0x80131505, "COR_E_TIMEOUT", null, "corerror.h");
        ADD(0x80131505, "COR_E_TIMEOUT", null, "corerror.h");
        ...
        ADD(0x80131506, "COR_E_EXECUTIONENGINE", null, "corerror.h");
        ADD(0x80131507, "COR_E_FIELDACCESS", "Access to this field is denied.", "corerror.h");
        ADD(0x80131507, "COR_E_FIELDACCESS", null, "corerror.h");
        ...
        ADD(0x80131531, "COR_E_INVALIDOLEVARIANTTYPE", null, "corerror.h");
        ADD(0x80131532, "COR_E_MISSINGMANIFESTRESOURCE", "An expected resource in the assembly manifest was missing.", "corerror.h");
        ADD(0x80131532, "COR_E_MISSINGMANIFESTRESOURCE", null, "corerror.h");
        ...
        ADD(0x80131538, "COR_E_SAFEARRAYRANKMISMATCH", null, "corerror.h");
        ADD(0x80131539, "COR_E_PLATFORMNOTSUPPORTED", "The method is not supported on this platform", "corerror.h");
        ADD(0x80131539, "COR_E_PLATFORMNOTSUPPORTED", null, "corerror.h");
        ...
        ADD(0x8013153a, "COR_E_INVALIDPROGRAM", null, "corerror.h");
        ADD(0x8013153b, "COR_E_OPERATIONCANCELED", "The operation was cancelled.", "corerror.h");
        ADD(0x8013153b, "COR_E_OPERATIONCANCELED", null, "corerror.h");
        ...
        ADD(0x8013153d, "COR_E_INSUFFICIENTMEMORY", null, "corerror.h");
        ...
        ADD(0x8013153e, "COR_E_RUNTIMEWRAPPED", null, "corerror.h");
        ADD(0x80131540, "COR_E_DEVICESNOTSUPPORTED", null, "corerror.h");
        ADD(0x80131540, "COR_E_DEVICESNOTSUPPORTED", null, "corerror.h");
        ADD(0x80131541, "COR_E_DATAMISALIGNED", "A datatype misalignment was detected in a load or store instruction.", "corerror.h");
        ADD(0x80131541, "COR_E_DATAMISALIGNED", null, "corerror.h");
        ADD(0x80131577, "COR_E_KEYNOTFOUND", null, "corerror.h");
        ADD(0x80131577, "COR_E_KEYNOTFOUND", null, "corerror.h");
        ADD(0x80131600, "COR_E_APPLICATION", "The base class for all \"less serious\" exceptions.", "corerror.h");
        ADD(0x80131600, "COR_E_APPLICATION", null, "corerror.h");
        ADD(0x80131601, "COR_E_INVALIDFILTERCRITERIA", "The given filter criteria does not match the filter contract.", "corerror.h");
        ADD(0x80131601, "COR_E_INVALIDFILTERCRITERIA", null, "corerror.h");
        ...
        ADD(0x80131641, "COR_E_ILLEGAL_REENTRANCY", null, "corerror.h");
        ...
        ADD(0x80131801, "VER_E_HRESULT", null, "corerror.h");
        ADD(0x80131802, "VER_E_OFFSET", null, "corerror.h");
        ADD(0x80131803, "VER_E_OPCODE", null, "corerror.h");
        ADD(0x80131804, "VER_E_OPERAND", null, "corerror.h");
        ADD(0x80131805, "VER_E_TOKEN", null, "corerror.h");
        ADD(0x80131806, "VER_E_EXCEPT", null, "corerror.h");
        ADD(0x80131807, "VER_E_STACK_SLOT", null, "corerror.h");
        ADD(0x80131808, "VER_E_LOC", null, "corerror.h");
        ADD(0x80131809, "VER_E_ARG", null, "corerror.h");
        ADD(0x8013180a, "VER_E_FOUND", null, "corerror.h");
        ADD(0x8013180b, "VER_E_EXPECTED", null, "corerror.h");
        ADD(0x8013180c, "VER_E_LOC_BYNAME", null, "corerror.h");
        ADD(0x80131810, "VER_E_UNKNOWN_OPCODE", null, "corerror.h");
        ADD(0x80131811, "VER_E_SIG_CALLCONV", null, "corerror.h");
        ADD(0x80131812, "VER_E_SIG_ELEMTYPE", null, "corerror.h");
        ADD(0x80131814, "VER_E_RET_SIG", null, "corerror.h");
        ADD(0x80131815, "VER_E_FIELD_SIG", null, "corerror.h");
        ADD(0x80131818, "VER_E_INTERNAL", null, "corerror.h");
        ADD(0x80131819, "VER_E_STACK_TOO_LARGE", null, "corerror.h");
        ADD(0x8013181a, "VER_E_ARRAY_NAME_LONG", null, "corerror.h");
        ADD(0x80131820, "VER_E_FALLTHRU", null, "corerror.h");
        ADD(0x80131821, "VER_E_TRY_GTEQ_END", null, "corerror.h");
        ADD(0x80131822, "VER_E_TRYEND_GT_CS", null, "corerror.h");
        ADD(0x80131823, "VER_E_HND_GTEQ_END", null, "corerror.h");
        ADD(0x80131824, "VER_E_HNDEND_GT_CS", null, "corerror.h");
        ADD(0x80131825, "VER_E_FLT_GTEQ_CS", null, "corerror.h");
        ADD(0x80131826, "VER_E_TRY_START", null, "corerror.h");
        ADD(0x80131827, "VER_E_HND_START", null, "corerror.h");
        ADD(0x80131828, "VER_E_FLT_START", null, "corerror.h");
        ADD(0x80131829, "VER_E_TRY_OVERLAP", null, "corerror.h");
        ADD(0x8013182a, "VER_E_TRY_EQ_HND_FIL", null, "corerror.h");
        ADD(0x8013182b, "VER_E_TRY_SHARE_FIN_FAL", null, "corerror.h");
        ADD(0x8013182c, "VER_E_HND_OVERLAP", null, "corerror.h");
        ADD(0x8013182d, "VER_E_HND_EQ", null, "corerror.h");
        ADD(0x8013182e, "VER_E_FIL_OVERLAP", null, "corerror.h");
        ADD(0x8013182f, "VER_E_FIL_EQ", null, "corerror.h");
        ADD(0x80131830, "VER_E_FIL_CONT_TRY", null, "corerror.h");
        ADD(0x80131831, "VER_E_FIL_CONT_HND", null, "corerror.h");
        ADD(0x80131832, "VER_E_FIL_CONT_FIL", null, "corerror.h");
        ADD(0x80131833, "VER_E_FIL_GTEQ_CS", null, "corerror.h");
        ADD(0x80131834, "VER_E_FIL_START", null, "corerror.h");
        ADD(0x80131835, "VER_E_FALLTHRU_EXCEP", null, "corerror.h");
        ADD(0x80131836, "VER_E_FALLTHRU_INTO_HND", null, "corerror.h");
        ADD(0x80131837, "VER_E_FALLTHRU_INTO_FIL", null, "corerror.h");
        ADD(0x80131838, "VER_E_LEAVE", null, "corerror.h");
        ADD(0x80131839, "VER_E_RETHROW", null, "corerror.h");
        ADD(0x8013183a, "VER_E_ENDFINALLY", null, "corerror.h");
        ADD(0x8013183b, "VER_E_ENDFILTER", null, "corerror.h");
        ADD(0x8013183c, "VER_E_ENDFILTER_MISSING", null, "corerror.h");
        ADD(0x8013183d, "VER_E_BR_INTO_TRY", null, "corerror.h");
        ADD(0x8013183e, "VER_E_BR_INTO_HND", null, "corerror.h");
        ADD(0x8013183f, "VER_E_BR_INTO_FIL", null, "corerror.h");
        ADD(0x80131840, "VER_E_BR_OUTOF_TRY", null, "corerror.h");
        ADD(0x80131841, "VER_E_BR_OUTOF_HND", null, "corerror.h");
        ADD(0x80131842, "VER_E_BR_OUTOF_FIL", null, "corerror.h");
        ADD(0x80131843, "VER_E_BR_OUTOF_FIN", null, "corerror.h");
        ADD(0x80131844, "VER_E_RET_FROM_TRY", null, "corerror.h");
        ADD(0x80131845, "VER_E_RET_FROM_HND", null, "corerror.h");
        ADD(0x80131846, "VER_E_RET_FROM_FIL", null, "corerror.h");
        ADD(0x80131847, "VER_E_BAD_JMP_TARGET", null, "corerror.h");
        ADD(0x80131848, "VER_E_PATH_LOC", null, "corerror.h");
        ADD(0x80131849, "VER_E_PATH_THIS", null, "corerror.h");
        ADD(0x8013184a, "VER_E_PATH_STACK", null, "corerror.h");
        ADD(0x8013184b, "VER_E_PATH_STACK_DEPTH", null, "corerror.h");
        ADD(0x8013184c, "VER_E_THIS", null, "corerror.h");
        ADD(0x8013184d, "VER_E_THIS_UNINIT_EXCEP", null, "corerror.h");
        ADD(0x8013184e, "VER_E_THIS_UNINIT_STORE", null, "corerror.h");
        ADD(0x8013184f, "VER_E_THIS_UNINIT_RET", null, "corerror.h");
        ADD(0x80131850, "VER_E_THIS_UNINIT_V_RET", null, "corerror.h");
        ADD(0x80131851, "VER_E_THIS_UNINIT_BR", null, "corerror.h");
        ADD(0x80131852, "VER_E_LDFTN_CTOR", null, "corerror.h");
        ADD(0x80131853, "VER_E_STACK_NOT_EQ", null, "corerror.h");
        ADD(0x80131854, "VER_E_STACK_UNEXPECTED", null, "corerror.h");
        ADD(0x80131855, "VER_E_STACK_EXCEPTION", null, "corerror.h");
        ADD(0x80131856, "VER_E_STACK_OVERFLOW", null, "corerror.h");
        ADD(0x80131857, "VER_E_STACK_UNDERFLOW", null, "corerror.h");
        ADD(0x80131858, "VER_E_STACK_EMPTY", null, "corerror.h");
        ADD(0x80131859, "VER_E_STACK_UNINIT", null, "corerror.h");
        ADD(0x8013185a, "VER_E_STACK_I_I4_I8", null, "corerror.h");
        ADD(0x8013185b, "VER_E_STACK_R_R4_R8", null, "corerror.h");
        ADD(0x8013185c, "VER_E_STACK_NO_R_I8", null, "corerror.h");
        ADD(0x8013185d, "VER_E_STACK_NUMERIC", null, "corerror.h");
        ADD(0x8013185e, "VER_E_STACK_OBJREF", null, "corerror.h");
        ADD(0x8013185f, "VER_E_STACK_P_OBJREF", null, "corerror.h");
        ADD(0x80131860, "VER_E_STACK_BYREF", null, "corerror.h");
        ADD(0x80131861, "VER_E_STACK_METHOD", null, "corerror.h");
        ADD(0x80131862, "VER_E_STACK_ARRAY_SD", null, "corerror.h");
        ADD(0x80131863, "VER_E_STACK_VALCLASS", null, "corerror.h");
        ADD(0x80131864, "VER_E_STACK_P_VALCLASS", null, "corerror.h");
        ADD(0x80131865, "VER_E_STACK_NO_VALCLASS", null, "corerror.h");
        ADD(0x80131866, "VER_E_LOC_DEAD", null, "corerror.h");
        ADD(0x80131867, "VER_E_LOC_NUM", null, "corerror.h");
        ADD(0x80131868, "VER_E_ARG_NUM", null, "corerror.h");
        ADD(0x80131869, "VER_E_TOKEN_RESOLVE", null, "corerror.h");
        ADD(0x8013186a, "VER_E_TOKEN_TYPE", null, "corerror.h");
        ADD(0x8013186b, "VER_E_TOKEN_TYPE_MEMBER", null, "corerror.h");
        ADD(0x8013186c, "VER_E_TOKEN_TYPE_FIELD", null, "corerror.h");
        ADD(0x8013186d, "VER_E_TOKEN_TYPE_SIG", null, "corerror.h");
        ADD(0x8013186e, "VER_E_UNVERIFIABLE", null, "corerror.h");
        ADD(0x8013186f, "VER_E_LDSTR_OPERAND", null, "corerror.h");
        ADD(0x80131870, "VER_E_RET_PTR_TO_STACK", null, "corerror.h");
        ADD(0x80131871, "VER_E_RET_VOID", null, "corerror.h");
        ADD(0x80131872, "VER_E_RET_MISSING", null, "corerror.h");
        ADD(0x80131873, "VER_E_RET_EMPTY", null, "corerror.h");
        ADD(0x80131874, "VER_E_RET_UNINIT", null, "corerror.h");
        ADD(0x80131875, "VER_E_ARRAY_ACCESS", null, "corerror.h");
        ADD(0x80131876, "VER_E_ARRAY_V_STORE", null, "corerror.h");
        ADD(0x80131877, "VER_E_ARRAY_SD", null, "corerror.h");
        ADD(0x80131878, "VER_E_ARRAY_SD_PTR", null, "corerror.h");
        ADD(0x80131879, "VER_E_ARRAY_FIELD", null, "corerror.h");
        ADD(0x8013187a, "VER_E_ARGLIST", null, "corerror.h");
        ADD(0x8013187b, "VER_E_VALCLASS", null, "corerror.h");
        ADD(0x8013187c, "VER_E_METHOD_ACCESS", null, "corerror.h");
        ADD(0x8013187d, "VER_E_FIELD_ACCESS", null, "corerror.h");
        ADD(0x8013187e, "VER_E_DEAD", null, "corerror.h");
        ADD(0x8013187f, "VER_E_FIELD_STATIC", null, "corerror.h");
        ADD(0x80131880, "VER_E_FIELD_NO_STATIC", null, "corerror.h");
        ADD(0x80131881, "VER_E_ADDR", null, "corerror.h");
        ADD(0x80131882, "VER_E_ADDR_BYREF", null, "corerror.h");
        ADD(0x80131883, "VER_E_ADDR_LITERAL", null, "corerror.h");
        ADD(0x80131884, "VER_E_INITONLY", null, "corerror.h");
        ADD(0x80131885, "VER_E_THROW", null, "corerror.h");
        ADD(0x80131886, "VER_E_CALLVIRT_VALCLASS", null, "corerror.h");
        ADD(0x80131887, "VER_E_CALL_SIG", null, "corerror.h");
        ADD(0x80131888, "VER_E_CALL_STATIC", null, "corerror.h");
        ADD(0x80131889, "VER_E_CTOR", null, "corerror.h");
        ADD(0x8013188a, "VER_E_CTOR_VIRT", null, "corerror.h");
        ADD(0x8013188b, "VER_E_CTOR_OR_SUPER", null, "corerror.h");
        ADD(0x8013188c, "VER_E_CTOR_MUL_INIT", null, "corerror.h");
        ADD(0x8013188d, "VER_E_SIG", null, "corerror.h");
        ADD(0x8013188e, "VER_E_SIG_ARRAY", null, "corerror.h");
        ADD(0x8013188f, "VER_E_SIG_ARRAY_PTR", null, "corerror.h");
        ADD(0x80131890, "VER_E_SIG_ARRAY_BYREF", null, "corerror.h");
        ADD(0x80131891, "VER_E_SIG_ELEM_PTR", null, "corerror.h");
        ADD(0x80131892, "VER_E_SIG_VARARG", null, "corerror.h");
        ADD(0x80131893, "VER_E_SIG_VOID", null, "corerror.h");
        ADD(0x80131894, "VER_E_SIG_BYREF_BYREF", null, "corerror.h");
        ADD(0x80131896, "VER_E_CODE_SIZE_ZERO", null, "corerror.h");
        ADD(0x80131897, "VER_E_BAD_VARARG", null, "corerror.h");
        ADD(0x80131898, "VER_E_TAIL_CALL", null, "corerror.h");
        ADD(0x80131899, "VER_E_TAIL_BYREF", null, "corerror.h");
        ADD(0x8013189a, "VER_E_TAIL_RET", null, "corerror.h");
        ADD(0x8013189b, "VER_E_TAIL_RET_VOID", null, "corerror.h");
        ADD(0x8013189c, "VER_E_TAIL_RET_TYPE", null, "corerror.h");
        ADD(0x8013189d, "VER_E_TAIL_STACK_EMPTY", null, "corerror.h");
        ADD(0x8013189e, "VER_E_METHOD_END", null, "corerror.h");
        ADD(0x8013189f, "VER_E_BAD_BRANCH", null, "corerror.h");
        ADD(0x801318a0, "VER_E_FIN_OVERLAP", null, "corerror.h");
        ADD(0x801318a1, "VER_E_LEXICAL_NESTING", null, "corerror.h");
        ADD(0x801318a2, "VER_E_VOLATILE", null, "corerror.h");
        ADD(0x801318a3, "VER_E_UNALIGNED", null, "corerror.h");
        ADD(0x801318a4, "VER_E_INNERMOST_FIRST", null, "corerror.h");
        ADD(0x801318a5, "VER_E_CALLI_VIRTUAL", null, "corerror.h");
        ADD(0x801318a6, "VER_E_CALL_ABSTRACT", null, "corerror.h");
        ADD(0x801318a7, "VER_E_STACK_UNEXP_ARRAY", null, "corerror.h");
        ADD(0x801318a8, "VER_E_NOT_IN_GC_HEAP", null, "corerror.h");
        ADD(0x801318a9, "VER_E_TRY_N_EMPTY_STACK", null, "corerror.h");
        ADD(0x801318aa, "VER_E_DLGT_CTOR", null, "corerror.h");
        ADD(0x801318ab, "VER_E_DLGT_BB", null, "corerror.h");
        ADD(0x801318ac, "VER_E_DLGT_PATTERN", null, "corerror.h");
        ADD(0x801318ad, "VER_E_DLGT_LDFTN", null, "corerror.h");
        ADD(0x801318ae, "VER_E_FTN_ABSTRACT", null, "corerror.h");
        ADD(0x801318af, "VER_E_SIG_C_VC", null, "corerror.h");
        ADD(0x801318b0, "VER_E_SIG_VC_C", null, "corerror.h");
        ADD(0x801318b1, "VER_E_BOX_PTR_TO_STACK", null, "corerror.h");
        ADD(0x801318b2, "VER_E_SIG_BYREF_TB_AH", null, "corerror.h");
        ADD(0x801318b3, "VER_E_SIG_ARRAY_TB_AH", null, "corerror.h");
        ADD(0x801318b4, "VER_E_ENDFILTER_STACK", null, "corerror.h");
        ADD(0x801318b5, "VER_E_DLGT_SIG_I", null, "corerror.h");
        ADD(0x801318b6, "VER_E_DLGT_SIG_O", null, "corerror.h");
        ADD(0x801318b7, "VER_E_RA_PTR_TO_STACK", null, "corerror.h");
        ADD(0x801318b8, "VER_E_CATCH_VALUE_TYPE", null, "corerror.h");
        ADD(0x801318b9, "VER_E_CATCH_BYREF", null, "corerror.h");
        ADD(0x801318ba, "VER_E_FIL_PRECEED_HND", null, "corerror.h");
        ADD(0x801318bb, "VER_E_LDVIRTFTN_STATIC", null, "corerror.h");
        ADD(0x801318bc, "VER_E_CALLVIRT_STATIC", null, "corerror.h");
        ADD(0x801318bd, "VER_E_INITLOCALS", null, "corerror.h");
        ADD(0x801318be, "VER_E_BR_TO_EXCEPTION", null, "corerror.h");
        ADD(0x801318bf, "VER_E_CALL_CTOR", null, "corerror.h");
        ADD(0x801318c0, "VER_E_VALCLASS_OBJREF_VAR", null, "corerror.h");
        ADD(0x801318c1, "VER_E_STACK_P_VALCLASS_OBJREF_VAR", null, "corerror.h");
        ADD(0x801318c2, "VER_E_SIG_VAR_PARAM", null, "corerror.h");
        ADD(0x801318c3, "VER_E_SIG_MVAR_PARAM", null, "corerror.h");
        ADD(0x801318c4, "VER_E_SIG_VAR_ARG", null, "corerror.h");
        ADD(0x801318c5, "VER_E_SIG_MVAR_ARG", null, "corerror.h");
        ADD(0x801318c6, "VER_E_SIG_GENERICINST", null, "corerror.h");
        ADD(0x801318c7, "VER_E_SIG_METHOD_INST", null, "corerror.h");
        ADD(0x801318c8, "VER_E_SIG_METHOD_PARENT_INST", null, "corerror.h");
        ADD(0x801318c9, "VER_E_SIG_FIELD_PARENT_INST", null, "corerror.h");
        ADD(0x801318ca, "VER_E_CALLCONV_NOT_GENERICINST", null, "corerror.h");
        ADD(0x801318cb, "VER_E_TOKEN_BAD_METHOD_SPEC", null, "corerror.h");
        ADD(0x801318cc, "VER_E_BAD_READONLY_PREFIX", null, "corerror.h");
        ADD(0x801318cd, "VER_E_BAD_CONSTRAINED_PREFIX", null, "corerror.h");
        ADD(0x801318ce, "VER_E_CIRCULAR_VAR_CONSTRAINTS", null, "corerror.h");
        ADD(0x801318cf, "VER_E_CIRCULAR_MVAR_CONSTRAINTS", null, "corerror.h");
        ADD(0x801318d0, "VER_E_UNSATISFIED_METHOD_INST", null, "corerror.h");
        ADD(0x801318d1, "VER_E_UNSATISFIED_METHOD_PARENT_INST", null, "corerror.h");
        ADD(0x801318d2, "VER_E_UNSATISFIED_FIELD_PARENT_INST", null, "corerror.h");
        ADD(0x801318d3, "VER_E_UNSATISFIED_BOX_OPERAND", null, "corerror.h");
        ADD(0x801318d4, "VER_E_CONSTRAINED_CALL_WITH_NON_BYREF_THIS", null, "corerror.h");
        ADD(0x801318d5, "VER_E_CONSTRAINED_OF_NON_VARIABLE_TYPE", null, "corerror.h");
        ADD(0x801318d6, "VER_E_READONLY_UNEXPECTED_CALLEE", null, "corerror.h");
        ADD(0x801318d7, "VER_E_READONLY_ILLEGAL_WRITE", null, "corerror.h");
        ADD(0x801318d8, "VER_E_READONLY_IN_MKREFANY", null, "corerror.h");
        ADD(0x801318d9, "VER_E_UNALIGNED_ALIGNMENT", null, "corerror.h");
        ADD(0x801318da, "VER_E_TAILCALL_INSIDE_EH", null, "corerror.h");
        ADD(0x801318db, "VER_E_BACKWARD_BRANCH", null, "corerror.h");
        ADD(0x801318dc, "VER_E_CALL_TO_VTYPE_BASE", null, "corerror.h");
        ADD(0x801318dd, "VER_E_NEWOBJ_OF_ABSTRACT_CLASS", null, "corerror.h");
        ADD(0x801318de, "VER_E_UNMANAGED_POINTER", null, "corerror.h");
        ADD(0x801318df, "VER_E_LDFTN_NON_FINAL_VIRTUAL", null, "corerror.h");
        ADD(0x801318e0, "VER_E_FIELD_OVERLAP", null, "corerror.h");
        ADD(0x801318e1, "VER_E_THIS_MISMATCH", null, "corerror.h");
        ADD(0x801318e2, "VER_E_STACK_I_I4", null, "corerror.h");
        ADD(0x801318f0, "VER_E_BAD_PE", null, "corerror.h");
        ADD(0x801318f1, "VER_E_BAD_MD", null, "corerror.h");
        ADD(0x801318f2, "VER_E_BAD_APPDOMAIN", null, "corerror.h");
        ADD(0x801318f3, "VER_E_TYPELOAD", null, "corerror.h");
        ADD(0x801318f4, "VER_E_PE_LOAD", null, "corerror.h");
        ADD(0x801318f5, "VER_E_WRITE_RVA_STATIC", null, "corerror.h");
        ADD(0x80131904, "COR_E_SqlException", "System.Data.SqlClient.SqlClientException", "corerror.h");
        ADD(0x80131920, "COR_E_Data", null, "corerror.h");
        ADD(0x80131921, "COR_E_DataDeletedRowInaccessible", null, "corerror.h");
        ADD(0x80131922, "COR_E_DataDuplicateName", null, "corerror.h");
        ADD(0x80131923, "COR_E_DataInRowChangingEvent", null, "corerror.h");
        ADD(0x80131924, "COR_E_DataInvalidConstraint", null, "corerror.h");
        ADD(0x80131925, "COR_E_DataMissingPrimaryKey", null, "corerror.h");
        ADD(0x80131926, "COR_E_DataNoNullAllowed", null, "corerror.h");
        ADD(0x80131927, "COR_E_DataReadOnly", null, "corerror.h");
        ADD(0x80131928, "COR_E_DataRowNotInTable", null, "corerror.h");
        ADD(0x80131929, "COR_E_DataVersionNotFound", null, "corerror.h");
        ADD(0x8013192a, "COR_E_DataConstraint", null, "corerror.h");
        ADD(0x8013192b, "COR_E_StrongTyping", null, "corerror.h");
        ADD(0x80131930, "COR_E_SqlType", null, "corerror.h");
        ADD(0x80131931, "COR_E_SqlNullValue", null, "corerror.h");
        ADD(0x80131932, "COR_E_SqlTruncate", null, "corerror.h");
        ADD(0x80131933, "COR_E_AdapterMapping", null, "corerror.h");
        ADD(0x80131934, "COR_E_DataAdapter", null, "corerror.h");
        ADD(0x80131935, "COR_E_DBConcurrency", null, "corerror.h");
        ADD(0x80131936, "COR_E_OperationAborted", null, "corerror.h");
        ADD(0x80131937, "COR_E_InvalidUdt", null, "corerror.h");
        ...
        ADD(0x80131940, "COR_E_Xml", null, "corerror.h");
        ADD(0x80131941, "COR_E_XmlSchema", null, "corerror.h");
        ADD(0x80131942, "COR_E_XmlXslt", null, "corerror.h");
        ADD(0x80131943, "COR_E_XmlXPath", null, "corerror.h");
        ADD(0x80131944, "COR_E_XmlQuery", null, "corerror.h");
        ...
        ADD(0x80131b0b, "VLDTR_E_NC_BADNESTED", "Bad \"nested\" token in NestedClass", "corerror.h");
        ADD(0x80131b0c, "VLDTR_E_NC_BADENCLOSER", "Bad \"enclosing\" token in NestedClass", "corerror.h");
        ...
        ADD(0x80131b24, "VLDTR_E_SIG_BADVOID", "Illegal \"void\" in signature", "corerror.h");
        ...
        ADD(0x80131c27, "CORDBG_E_MINIDUMP_UNSUPPORTED", null, "corerror.h");
        ...
        ADD(0x80131fff, "CLDB_E_INTERNALERROR", null, "corerror.h");
    };
    ON_INIT{
